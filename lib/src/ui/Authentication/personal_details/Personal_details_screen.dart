    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            enabled: false,
            style: TextStyle(color: mainRedShadeForText),
            decoration: InputDecoration(
              label: Text(Address),
              border: OutlineInputBorder(
                borderSide: BorderSide(color: mainRedShadeForText),
          ...
          //   labelText: Address,
          //   isObscured: false,
          //   textFieldIcon: const ImageIcon(AssetImage('assets/images/SEARCH.png')),
          // ),
          const SizedBox(
            height: 30,
          ),
    ...
    return Row(
      ...
      children: [
        PickFavContainerWidget(
          ...
          favImageWidget: const DecorationImage(
