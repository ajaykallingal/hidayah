      ...
      children: [
        InkWell(
          ...
          child: RoundedTextFieldWithRadioButton(
            context: context,
            text: 'Pray 5 Prayers',
            isChecked: userDataGoals1 == "1" ?  !isPrayerChecked : isPrayerChecked,
          ),
        ),
        SizedBox(height: 20),
        InkWell(
          ...
          child: RoundedTextFieldWithRadioButton(
            ...
            isChecked: userDataGoals2 == "1" ? !isReadAyahChecked : isReadAyahChecked,
          ),
        ),
        SizedBox(height: 20),
        InkWell(
          ...
          child: RoundedTextFieldWithRadioButton(
            ...
            isChecked: userDataGoals3 == "1" ? !isSayDuaChecked : isSayDuaChecked,
          ),
        ),
        SizedBox(height: 20),
        InkWell(
          ...
          child: RoundedTextFieldWithRadioButton(
            ...
            isChecked: userDataGoals4 == "1" ? !isPrayWitrChecked : isPrayWitrChecked,
          ),
        ),
        SizedBox(height: 20),
        InkWell(
          ...
          child: RoundedTextFieldWithRadioButton(
            ...
            isChecked: userDataGoals5 == "1" ? !isGiveCharityChecked : isGiveCharityChecked,
          ),
        ),
      ],
    );
