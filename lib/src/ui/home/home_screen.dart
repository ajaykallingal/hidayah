...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    super.initState();
    //
    userDataGoals1 = ObjectFactory()
        .prefs
        .getUserData()!
        .response!
        .userGoalPrayFive
        .toString();
    userDataGoals2 = ObjectFactory()
        .prefs
        .getUserData()!
        .response!
        .userGoalReadTwentyAyaDaily
        .toString();
    userDataGoals3 = ObjectFactory()
        .prefs
        .getUserData()!
        .response!
        .userGoalSayThreeDua
        .toString();
    userDataGoals4 = ObjectFactory()
        .prefs
        .getUserData()!
        .response!
        .userGoalPrayWitrNight
        .toString();
    userDataGoals5 = ObjectFactory()
        .prefs
        .getUserData()!
        .response!
        .userGoalGiveCharity
                  ...
                  slivers: <Widget>[
                    SliverAppBar(
                      ...
                      flexibleSpace: FlexibleSpaceBar(
                        ...
                        background:Padding(
                          padding: const EdgeInsets.only(right: 12.0,top: 65,left: 12),
                          child: Row(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      ...
                                      upcomingPrayerTime == "00:00" ? Text("Will update before sunrise!",softWrap: true,) :
                                      Text(
        ...
        child: BottomNavigationBar(
          ...
          items: const [
            BottomNavigationBarItem(
                icon: ImageIcon(AssetImage('assets/images/SURAH FILL.png')),
                label: "Home"),
            BottomNavigationBarItem(
                icon: ImageIcon(AssetImage('assets/images/DIKR NAV.png')),
                label: "Dhikr"),
            BottomNavigationBarItem(
                icon: ImageIcon(AssetImage('assets/images/QURAN NAV.png')),
                label: "Quran"),
            BottomNavigationBarItem(
            ...
            BottomNavigationBarItem(
                ...
                label: "More"),
            BottomNavigationBarItem(
                icon: ImageIcon(AssetImage('assets/images/CALENDER NAV.png')),
                label: "Today"),
          ],
          onTap: _onTapped,
        ),
      ...
      child: HomePageCardWidget(
        child: Column(
          ...
          children: [
            ...
            Text(
              "Make sure you meet your daily goals!",
  ...
  Future buildLogoutPopUp(BuildContext context) async {
    await Alert(
      ...
      style: AlertStyle(
          ...
          constraints: const BoxConstraints(maxHeight: 80, maxWidth: 324),
