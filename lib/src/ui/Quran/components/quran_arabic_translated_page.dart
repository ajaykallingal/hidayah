                  ...
                  child: NestedScrollView(
                    ...
                    body: Padding(
                      ...
                      child: Container(
                        ...
                        child: loading ? Center(child: CircularProgressIndicator(color: mainRedShadeForTitle,),) : TabBarView(
                          ...
                          children: [
                            // Wrap(
                            //   children: List.generate(int.parse(displayWholeQuranFiltered![index].suartNumberOfAyats), (index) => Column(
                            //     children: [
                            //
                            //       Container(
                            //         width: MediaQuery.of(context).size.width,
