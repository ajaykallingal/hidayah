...
Color lightGreyShadeForText = const Color(0xFF9F9F9F).withOpacity(1.0);
Color mainRedShadeForText  = const Color(0xffD10005).withOpacity(0.5);
Color mainRedShadeForTitle = const Color(0xffD10005).withOpacity(1.0);
Color shadeForTextFieldBorder = const Color(0xffD10005).withOpacity(0.2);
