...
import 'package:hidayah/src/data/provider/calendar_add_event_api_provider.dart';
import 'package:hidayah/src/data/provider/calendar_delete_event_api_provider.dart';
...
class Repository{
  ...
  final calendarAddEventProvider = CalendarAddEventApiProvider();
  final calendarDeleteEventProvider = CalendarDeleteEventApiProvider();
  ...
  ///Calendar add events
  Future<StateModel?> fetchCalendarAddEvent(CalendarAddEventRequest request) =>
      calendarAddEventProvider.fetchCalendarAddEvent(request);

  ///Calendar delete events
  Future<StateModel?> calendarDeleteEvent(CalendarDeleteEventRequest request) =>
      calendarDeleteEventProvider.calendarDeleteEvent(request);
